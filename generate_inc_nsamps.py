...
if __name__=="__main__":
    ...
    Runs = [ 58, 68, 69, 74, 77, 79, 87, 91, 93, 94, 96, 98, 99, 101, 105, 108, 109, 118, 129, 132, 136, 142, 144, 146, 154, 155, 156, 165, 168, 200, 204, 207, 211, 231, 232, 236, 248]
    
    Nsamps = [100, 250, 500, 750, 1000, 1500, 2000, 5000, 10000, 20000]
    for i in Runs:
        for j in Nsamps:
            # find the input file
